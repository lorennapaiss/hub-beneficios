      ...
      <DialogContent className="max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-between rounded-lg border border-dashed border-border bg-muted/20 px-4 py-4 text-left transition-colors hover:border-primary/40 hover:bg-muted/40"
          >
            <div className="space-y-1">
              <div className="text-sm font-medium text-foreground">Selecionar arquivo CSV</div>
              <div className="text-xs text-muted-foreground">
                Clique aqui para escolher o arquivo que sera importado.
              </div>
            </div>
            <span className="rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground">
              Escolher arquivo
            </span>
          </button>
